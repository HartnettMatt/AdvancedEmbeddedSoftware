...
int Test_validate_username_main(void)
{
  UnityBegin("/home/matt/Documents/Education/Graduate/AdvancedEmbeddedSoftware/assignment-1-HartnettMatt/assignment-autotest/../student-test/assignment1/Test_validate_username.c");
